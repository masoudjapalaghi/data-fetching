...
async function getData(): Promise<ProductCardType[]> {
  const res = await fetch(config.apiUrlServer + "lists/", { next: { tags: ["revalidateTag"] } });
...
const ButtonRevalidate = () => {
  ...
  const handleRevalidate = () => {
    fetch("/api/revalidateAppRoute?tag=revalidateTag', {
      method: "GET",
      headers: {
