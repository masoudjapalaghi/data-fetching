    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          ...
          <a className="p-2 border-2 border-teal-200 text-teal-200 rounded-md mx-2 transition-all hover:bg-teal-200 hover:text-black" href="https://data-fetching-nextjs.vercel.app/" target="_blank">Vercel</a>
          <a className="p-2 border-2 border-teal-200 text-teal-200 rounded-md mx-2 transition-all hover:bg-teal-200 hover:text-black" href="https://affectionate-perlman-pgafk5cw4.liara.run/" target="_blank">Liara</a>
          <a className="p-2 border-2 border-teal-200 text-teal-200 rounded-md mx-2 transition-all hover:bg-teal-200 hover:text-black" href="https://github.com/masoudjapalaghi/data-fetching" target="_blank">github</a>
        </p>
